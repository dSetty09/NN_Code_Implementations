...
int main() {
    ...
    float single_output_input_two[2] = {-INFINITY, 9}; // input with arbitrarily large negative number
    float single_output_input_three[2] = {-9, INFINITY}; // input with arbitrarily large positive number
    ...
    float multiple_output_input_two[2] = {-INFINITY, 1}; // input with arbitrarily large number
    ...
    float multiple_output_ideal_outputs_one[2] = {1.0, 0.0};
    float multiple_output_ideal_outputs_two[2] = {0.0, 1.0};

    one_arg_activation_function backprop_act_funcs[3] = {NULL, sigmoid, leaky_relu};
