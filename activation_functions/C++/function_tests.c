...
void activation_function_test(one_arg_activation_function activation_function, const char* func_name, 
    ...
    for (int i = 0; i < num_tests; ++i) {
        ...
        if (isnan(actual_func_output)) assert(isnan(my_func_output));
...
int main() {
    ...
    float sigmoid_deriv_vals[7] = {0.25, 0.24026, 0, 0.22171, 0, 0, 0};
    ...
    float softplus_deriv_vals[7] = {0.5, 0.40131, 0, 0.66819, 1, 0, 1};
